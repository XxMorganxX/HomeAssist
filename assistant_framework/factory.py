...
try:
    ...
    from .providers.transcription import AssemblyAITranscriptionProvider
    from .providers.response import OpenAIWebSocketResponseProvider
    from .providers.tts import GoogleTTSProvider
    from .providers.context import UnifiedContextProvider
    from .providers.wakeword import OpenWakeWordProvider
except ImportError:
    ...
    from assistant_framework.providers.transcription import AssemblyAITranscriptionProvider
    from assistant_framework.providers.response import OpenAIWebSocketResponseProvider
    from assistant_framework.providers.tts import GoogleTTSProvider
    from assistant_framework.providers.context import UnifiedContextProvider
    from assistant_framework.providers.wakeword import OpenWakeWordProvider
