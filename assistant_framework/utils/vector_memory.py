...
class VectorMemoryManager:
    ...
    def format_for_context(self, memories: List[RetrievedMemory]) -> str:
        ...
        lines = [
            ...
            "(NOTE: This is background context only. When using tools, use ONLY the user's CURRENT request for parameters - never infer tool arguments from past conversations.)"
        ]
