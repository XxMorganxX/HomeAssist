...
MULTI_TURN_CONVERSATIONS = [
    ...
    [
        ...
        ("Add buy groceries", [{"name": "todos", "arguments": {"action": "create", "title": "buy groceries"}}]),
        ("Also add call mom", [{"name": "todos", "arguments": {"action": "create", "title": "call mom"}}]),
        ("Remove buy groceries", [{"name": "todos", "arguments": {"action": "delete", "match": "buy groceries"}}]),
    ],
    [
    ...
    [
        ("Add milk to my list", [{"name": "todos", "arguments": {"action": "create", "title": "milk"}}]),
        ("Add eggs too", [{"name": "todos", "arguments": {"action": "create", "title": "eggs"}}]),
        ("And bread", [{"name": "todos", "arguments": {"action": "create", "title": "bread"}}]),
        ("Show me the full list", [{"name": "todos", "arguments": {"action": "list"}}]),
    ],
    ...
    # Todo/reminder flow
    [
        ("Remind me to call the dentist at 2pm", [{"name": "todos", "arguments": {"action": "create", "title": "Call the dentist", "due_at": "2pm"}}]),
        ("What reminders do I have?", [{"name": "todos", "arguments": {"action": "list"}}]),
        ("Cancel the dentist reminder", [{"name": "todos", "arguments": {"action": "delete", "match": "dentist"}}]),
    ],
    [
        ("Set a reminder for 9am tomorrow", [{"name": "todos", "arguments": {"action": "create", "title": "Morning reminder", "due_at": "tomorrow 9am"}}]),
