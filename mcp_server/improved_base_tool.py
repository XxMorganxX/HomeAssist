"""
Improved base tool that generates FastMCP-compatible functions with rich parameter descriptions.
"""
...
class ImprovedBaseTool(ABC):
    """
    Improved base class for MCP tools that generates FastMCP-compatible functions
    with rich parameter descriptions directly in the function docstrings and signatures.
    """
